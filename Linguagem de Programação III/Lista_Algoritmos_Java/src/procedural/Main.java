...
public class Main {
	...
	static void ex04() {
		// Leia o número de dias trabalhados por um encanador (R$30/dia) e imprima a
		// quantia líquida com desconto de 8%.
	...
	static void ex05() {
		// Divida R$780.000,00 entre 3 ganhadores (46%, 32% e o restante) e imprima os
		// valores.
	...
	static void ex06() {
		// Calcule o salário líquido de um professor, recebendo via teclado o valor da
		// hora aula, número de aulas e desconto do INSS.
	...
	static void ex07() {
		// Calcule o custo final de um carro com base no preço de fábrica, percentual do
		// distribuidor e dos impostos.
	...
	static void ex08() {
		// • Reajuste de salário com base em faixas: < 800 → 15%, 800 a 1000 → 10%, >
		// 1000 → 5%.
		...
		if (salario < 800) {
			...
			System.out.printf("O salario reajustado em 15%% é de R$%.2f\n", reajuste);

		} else if (salario <= 1000) {
			reajuste = salario * 1.10;
			System.out.printf(" O salário reajustado em 10%% é de R$%.2f\n", reajuste);
		}

		else {
			reajuste = salario * 1.05;
			System.out.printf("O salário reajustado em 5%% é de R$%.2f \n", reajuste);
		}
